...
// Calculadora4A.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CCalculadora4AApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CCalculadora4AApp

CCalculadora4AApp::CCalculadora4AApp()
{
...
// Único objeto CCalculadora4AApp

CCalculadora4AApp theApp;


// Inicialización de CCalculadora4AApp

BOOL CCalculadora4AApp::InitInstance()
{
